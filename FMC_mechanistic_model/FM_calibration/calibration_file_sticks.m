function [SSE] = calibration_file_sticks(p)

%% Calibration %%

q(1)  = 400;            % Stick density (400 [kg/m3], Nelson, 2000)
...
b       = p(7); 
[p1,sv] = forcing_minutes(b,p);
q(23)   = sv; 

if b == 1 % DRO
    b1 = 1;  % 9125 DRO 2237 MLES 2253 MLRF 2513 PNW 6981 STCK 2464 HQ_AWC
    a1 = 33550; % 10505 DRO 19809 MLES 22351 MLRF 10516 PNW STCK 19983 HQ_AWC
elseif b == 2 % HQ_AWC
    b1 = 1; % 28831 DRO 2237 MLES 2253 MLRF 2513 PNW 6981 STCK 2464 HQ_AWC
    a1 = 33550; % 33550 DRO 19809 MLES 22351 MLRF 10516 PNW STCK 19983 HQ_AWC
elseif b == 3 % MLES
    b1 = 1; % 28831 DRO 2237 MLES 2253 MLRF 2513 PNW 6981 STCK 2464 HQ_AWC
    a1 = 33550; % 33550 DRO 19809 MLES 22351 MLRF 10516 PNW STCK 19983 HQ_AWC
elseif b == 4 % MLRF
    b1 = 1; % 2253 MLRF 2513 PNW 6981 STCK 2464 HQ_AWC ALL 1
    a1 = 33550; % 10551 MLRF 10516 PNW STCK 19983 HQ_AWC ALL 31509
elseif b == 5 % PNW
    b1 = 1; % 2513 PNW 6981 STCK 2464 HQ_AWC
    a1 = 33550; % 10516 PNW STCK 19983 HQ_AWC
else % STCK
    b1 = 1; % 2513 PNW 6981 STCK 2464 HQ_AWC
    a1 = 33550; % 10516 PNW STCK 19983 HQ_AWC
end
%  sum(isnan(fuel_moist))
...
%% NSE FOR THE WHOLE YEAR WITHOUT RESTRICTION %%

SSE  = (sum(((fuel_moist-m_s)./fuel_err).^2))^0.5
SSE_1  = (sum(((fuel_moist-m_s)).^2))^0.5
% plot((fuel_moist-m_s))
