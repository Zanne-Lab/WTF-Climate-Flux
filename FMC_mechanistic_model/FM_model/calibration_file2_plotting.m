function [output] = calibration_file2_plotting(p)
...
q(17) = 60*60*1.9e-5;   % Thermal diffusivity of the air [1.9 × 10^-5 m2/(h)]
...
elseif b == 5 % PNW
    ...
    b1 = 1; % 6981 STCK 2464 HQ_AWC
    a1 = 35305; % 12081 STCK 19983 HQ_AWC
end
